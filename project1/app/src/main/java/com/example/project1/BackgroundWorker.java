...
//This is used to get query from the sever easier!
//it will check for the user first parameter to see which query it will post to
public class BackgroundWorker extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        if ((type.equals("login"))) {
            ...
            String photoref = params[4];
            Log.i(TAG, " insert history " +userID + " " + placeID + " "+ rname + " "+ photoref);
            try {
                ...
                String post_data = URLEncoder.encode("rName","UTF-8")+"="+URLEncoder.encode(rname,"UTF-8")+"&"+
                        ...
                        URLEncoder.encode("userID","UTF-8")+"="+URLEncoder.encode(userID,"UTF-8")+"&"+
                        URLEncoder.encode("photoref","UTF-8")+"="+URLEncoder.encode(photoref,"UTF-8");
                bufferedWriter.write(post_data);
                bufferedWriter.flush();
                bufferedWriter.close();
                outputStream.close();
            ...
            if ((type2.equals("placeID"))||(type2.equals("photoref"))) {
                String rname=params[3];
